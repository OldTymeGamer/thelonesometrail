...
* **Priority points from different sources are cumulative, meaning points from whitelist jobs, priority packages, and crash priority all stack together**. This allows players to maximize their queue position by combining points from multiple sources.
